    ...
    <div class="search-table">
      <div class="search">
        <el-row :gutter="10" style="padding:10px">
          ...
          <!-- 学段搜索 -->
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <span class="search-title">学段:</span>
          ...
          <!-- 教材搜索 -->
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <span class="search-title">教材:</span>
            <el-input
                style="margin-top:10px"
                size="mini"
                placeholder="请输入教材"
                v-model="search.textbook">
            </el-input>
          </el-col>
          <!-- 年级搜索 -->
          <el-col :xs="24" :sm="12" :md="8" :lg="8" :xl="8">
            <span class="search-title">年级:</span>
            <el-input
                style="margin-top:10px"
                size="mini"
                placeholder="请输入年级"
...
export default {
  ...
  methods: {
    ...
    refresh() {
      ...
      this.search.gradeLevel = ""   // 重置学段
      this.search.textbook = ""     // 重置教材
      this.search.grade = ""        // 重置年级
      this.query()
    },
